  ...
  return (
    <div className="text-center py-12 px-4">
      ...
      <div className="flex flex-wrap justify-center gap-8">
        <div className="bg-gray-800 text-white rounded-lg p-6 w-full sm:w-80">
      ...
      <div className="mt-20 md:mt-40 bg-orange-300 p-10">
        <h1 className="text-2xl md:text-[20px] text-black mb-4">
          Get the Services from us to DETOX AND REPAIR YOUR BODY & FIGHT DISEASE
        </h1>
        <Link to="/signup">
          <button className="bg-orange-600 text-white font-bold py-2 px-8 rounded hover:bg-orange-400 hover:text-black">
            JOIN US
          </button>
        </Link>
      </div>
